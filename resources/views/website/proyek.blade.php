            ...
            <div class="card-body">
                <div class="row">
                    ...
                    @foreach ($proyeks as $proyek)
                        <div class="col-sm-3">
                            <div class="card">
                                <img class="card-img-top" src="{{ url('images/'.$proyek->gambar_proyek) }}" alt="Card image cap" style="height: 150px;">
                                <div class="card-body">
                                    <h4 class="card-title"><a href="{{ route('detail-proyek',$proyek->kode_proyek) }}" title="View Product">{{ $proyek->nama_proyek }}</a></h4>
                                    <p class="card-text"></p>
                                    <div class="row">
                                        <div class="col-sm-12">
