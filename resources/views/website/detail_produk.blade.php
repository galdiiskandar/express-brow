    ...
    <div class="card bg-light mb-3">
        <div class="card-body">
            <a href="" data-toggle="modal" data-target="#productModal">
                <img class="img-fluid" src="{{ url('images/'.$detailBarang->gambar_produk) }}" />
            </a>
        </div>
    </div>
</div>
...
<div class="col-12 col-lg-6 add_to_cart_block">
    <div class="card bg-light mb-3">
        <div class="card-body">
            <p class="product-label">{{ $detailBarang->nama_produk }}</p>
            <p class="price">{{ 'Rp.'.number_format($detailBarang->harga) }}</p>
            <br>
            <p>{{ $detailBarang->keterangan }}</p>
